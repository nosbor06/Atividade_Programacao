	...
	class Program
	{
		...
		public static void ExibirCarrosDisponiveis()
		{
			...
			for (int i = 0; i < totalCarros; i++)
			{
				...
				{
					encontrou = true;
					string status = carroEmprestado[i] ? " (Emprestado)" : " (Disponível)";
		...
		public static void ExibirMotosDisponiveis()
		{
			...
			for (int i = 0; i < totalMotos; i++)
			{
				...
				{
					encontrou = true;
					string status = motoEmprestada[i] ? " (Emprestada)" : " (Disponível)";
		...
		{
			Console.WriteLine("Emprestar Produto");
			Console.WriteLine("Escolha o tipo de produto que deseja emprestar:");
			Console.WriteLine("1 : Carros");
			Console.WriteLine("2 : Motos");
			...
			{
				case 1:
					Console.WriteLine("Escolha o carro que deseja emprestar (Digite o número):");
					ExibirCarrosDisponiveis();
					...
					if (indiceCarro >= 0 && indiceCarro < totalCarros)
					{
						...
						else if (carroEmprestado[indiceCarro])
						{
							...
							Console.WriteLine("O carro " + carros[indiceCarro] + " já está emprestado.");
						}
						else
						{
							carroEmprestado[indiceCarro] = true;
							Console.WriteLine("Você emprestou o carro " + carros[indiceCarro] + " com valor de " + carrosPreços[indiceCarro] + ".");
						}
					}
					else
					{
				...
				case 2:
					Console.WriteLine("Escolha a moto que deseja emprestar (Digite o número):");
					ExibirMotosDisponiveis();
					...
					if (indiceMoto >= 0 && indiceMoto < totalMotos)
					{
						...
						else if (motoEmprestada[indiceMoto])
						{
							...
							Console.WriteLine("A moto " + motos[indiceMoto] + " já está emprestada.");
						}
						else
						{
							motoEmprestada[indiceMoto] = true;
							Console.WriteLine("Você emprestou a moto " + motos[indiceMoto] + " com valor de " + motosPreços[indiceMoto] + ".");
						}
					}
					else
					{
